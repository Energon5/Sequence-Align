def findMatches (motif1, motif2, nummotifs):
	import pandas as pd
	...
	for index, i in enumerate(m1list):
		...
		for index, j in enumerate(m2list):
			...
			#If statement to be un-commented if required. Checks for text marking genes as dupes. Found to not be necessary in counting the average.	
...
nummots = raw_input("Please enter total genes tested: ")
findMatches(tomatch1,tomatch2, nummots)
